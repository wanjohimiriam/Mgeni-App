...
public final class ActivityCheckOutBinding implements ViewBinding {
  ...
  private ActivityCheckOutBinding(@NonNull FrameLayout rootView, @NonNull TextInputEditText IdText,
  ...
  public static ActivityCheckOutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCheckOutBinding((FrameLayout) rootView, IdText, IdTextField, NameTextField,
