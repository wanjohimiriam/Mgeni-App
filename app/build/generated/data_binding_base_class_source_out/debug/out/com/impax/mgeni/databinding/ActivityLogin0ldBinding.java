...
public final class ActivityLogin0ldBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityLogin0ldBinding(@NonNull ConstraintLayout rootView, @NonNull Button OTPBtn,
      ...
      @NonNull CardView phoneLayout, @NonNull TextView resetPass, @NonNull TabLayout tabs,
      @NonNull TextInputEditText textPassword, @NonNull TextInputEditText textPhone,
      @NonNull TextInputLayout usernameTextField, @NonNull ViewPager viewpager) {
  ...
  @NonNull
  public static ActivityLogin0ldBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityLogin0ldBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_login_0ld, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityLogin0ldBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLogin0ldBinding((ConstraintLayout) rootView, OTPBtn, PasswordTextField,
          PhoneTextField, companyLayout, emailAddress, emailLabel, loginBtn, logoView, passLabel,
          passLayout, phoneLabel, phoneLayout, resetPass, tabs, textPassword, textPhone,
          usernameTextField, viewpager);
    }
